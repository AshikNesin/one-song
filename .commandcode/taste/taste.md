...
- Always bump the patch version for semantic versioning (e.g., 0.0.1 → 0.0.2); bump both versionCode and versionName in Android builds together. Confidence: 0.80
